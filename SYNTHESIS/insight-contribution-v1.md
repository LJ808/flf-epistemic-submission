...
**This prediction stands as falsifiable.** If running the actual ingestion on CERN FAQ material produces a model-dependency or chain-dependency instead of a scope-dependency, the typology needs revision — either a fourth category, or evidence that the three-case-shape framing collapses into fewer categories than predicted. Either outcome adds real information; this doesn't work as a hedge — it specifies a test condition in advance of running it.
